    ...
    render() {
        ...
        return (
            <DoubleConteiner>
                ...
                <SwipeableDrawer style={{width: '50vw'}} anchor="left" open={this.state.open} onOpen={this.handleDrawerOpen} onClose={this.handleDrawerClose}>
                    <List style={{ background: "#121212", position: "relative", height: "100vh", width: "100%", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                        <IconButton style={{ position: "absolute", top: '50vh', right: '50px' }} onClick={this.handleDrawerClose}>
